...
using UnityEngine;
    ...
    class PyGesticulatorTestor
    {
        ...
        {
            Runtime.PythonDLL = @"C:/Users/jiinlee/opt/anaconda3/envs/gest_env.dll";
            ...
            (
                ...
                new string[]
                {
                      ...
                      @"C:/Users/jiinlee/Desktop/code-assignment3"
                }
            );
        ...
        public void Test()
        {
            using (Py.GIL())
            {
                ...
                Add_PySysPath(path: @"C:/Users/jiinlee/Desktop/code-assignment3");
                Add_PySysPath(path: @"C:/Users/jiinlee/Desktop/code-assignment3");
    
                dynamic demo_py = Py.Import("demo.demo");
                string audioPath = @"C:/Users/jiinlee/Desktop/code-assignment3\demo\input\jeremy_howard.wav";
